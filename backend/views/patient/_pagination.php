...
<!--    pagination -->
<form name="patient_list_form" action="/patient/index" style="display: <?= $data['show_pagination'] ? 'block' : 'none'; ?>">
    <input type="hidden" name="page" value="<?= $data['page'] ?>" />
    <input type="hidden" name="sort" value="<?= $data['sort'] ?>" />
    <input type="hidden" name="discount_patients" value="<?= $data['discount_patients']; ?>" />
    <div class="patients__pagination pagination__wrapper">
