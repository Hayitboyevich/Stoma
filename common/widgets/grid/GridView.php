...
class GridView extends BaseListView
{
     ...
     */
    public $layout = "<div class='patients__table'>{items}</div>\n{pager}";
    ...
    public function run()
    {
        ...
        $view->registerJs('jQuery(".pagination_right_select select").on("change", function(e){ window.location.href = $(this).find("option:selected").val() })');
        parent::run();
    }
    ...
    public function renderTableHeader()
    {
        ...
        return Html::tag('tr', implode('', $cells), $this->headerRowOptions);
