...
class DataColumn extends Column
{
    ...
    protected function renderHeaderCellContent()
    {
        ...
        if ($this->attribute !== null && $this->enableSorting &&
            ...
            $sortIcon = '<span class="filter_img"><img src="/img/icon_arrow.svg" alt=""><img src="/img/icon_arrow_down.svg" alt=""></span>';
             $link = $sort->link($this->attribute, array_merge($this->sortLinkOptions, ['label' => $sortIcon]));
        }

        return "<span>". $label ."</span> ".$link;
    }
